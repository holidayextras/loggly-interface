...
/*
* @name /lib/loggly-interface.js
* @description A logger module to send logs to Loggly
...
/**
	...
	* @param {Object} connectionOptions, proxies whatever is passed in as the logger.connection
	*/
