...
/*
* @name /lib/logglyInterface.js
* @description An interface to push data to a Loggly account
	...
	try {
		...
		if( log && options && options.service && options.type && options.namespace ) {
			...
			var httpsOptions = {
				...
				port: 443,
				// build a path containing our tag for loggly, this MUST contain a leading slash.
